...
.grid-pattern {
    ...
    height: 100%;
    background-image: 
        radial-gradient(#1e293b 1.6px, transparent 1.6px),
        linear-gradient(to right, rgba(30, 41, 59, 0.06) 1px, transparent 1px);
...
.circuit-ring {
    position: absolute;
    border: 2px dashed rgba(30, 41, 59, 0.22);
    border-radius: 50%;
    pointer-events: none;
    z-index: 1;
}
